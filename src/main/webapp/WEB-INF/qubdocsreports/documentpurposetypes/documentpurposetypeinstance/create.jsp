...
<div class="page-header">
	<h1><spring:message code="label.documentPurposeTypes.createDocumentPurposeTypeInstance" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/qubdocsreports/documentpurposetypes/documentpurposetypeinstance/"  ><spring:message code="label.event.back" /></a></div>
...
<div class="col-sm-10">
	<input id="documentPurposeTypeInstance_name" class="form-control" type="text" name="name"  bennu-localized-string value='${not empty param.name ? param.name : "{}" } ' required /> 
</div>
</div>		
<div class="form-group row">
