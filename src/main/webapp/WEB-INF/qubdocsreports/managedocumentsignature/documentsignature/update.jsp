...
<div class="page-header">
    <h1>
        <spring:message
            code="label.manageDocumentSignature.updateDocumentSignature" />
        <small></small>
    </h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}<%= DocumentSignatureController.READ_URL %>${documentSignature.externalId}"><spring:message
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="documentSignature_responsibleFunction"
                        ...
                        value='${not empty param.responsiblefunction ? param.responsiblefunction : documentSignature.responsibleFunction.json() } ' />
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                ...
                <div class="col-sm-10">
                    <input id="documentSignature_responsibleUnit"
                        ...
                        value='${not empty param.responsibleunit ? param.responsibleunit : documentSignature.responsibleUnit.json() } ' />
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.DocumentSignature.responsibleDefault" />
                </div>

                <div class="col-sm-2">
                    <select id="documentSignature_responsibleDefault"
                        name=responsibledefault class="form-control">
