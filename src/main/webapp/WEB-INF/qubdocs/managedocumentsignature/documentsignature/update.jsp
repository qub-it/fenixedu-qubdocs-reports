...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/qubdocs/managedocumentsignature/documentsignature/read/${documentSignature.externalId}" ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
